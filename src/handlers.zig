...
pub const ServerErrorHandler = struct {
    ...
    pub fn dispatch(self: *ServerErrorHandler, request: *Request, response: *Response) anyerror!void {
...
pub const NotFoundHandler = struct {
    ...
    pub fn dispatch(self: *NotFoundHandler, request: *Request, response: *Response) !void {
        _ = self;
        _ = request;
...
pub fn StaticFileHandler(comptime static_url: []const u8, comptime static_root: []const u8) type {
    ...
    return struct {
        ...
        pub fn get(self: *Self, request: *Request, response: *Response) !void {
        ...
        pub fn checkNotModified(self: Self, request: *Request, mtime: Datetime) bool {
        ...
        pub fn renderNotFound(self: Self, request: *Request, response: *Response) !void {
            _ = self;
...
pub fn WebsocketHandler(comptime Protocol: type) type {
    return struct {
        ...
        fn respondError(self: *Self, status: *const web.responses.Status) void {
